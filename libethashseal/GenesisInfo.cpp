...
#include "genesis/sbercoinMainNetwork.cpp"
...
#include "genesis/test/sbercoinTestNetwork.cpp"

//Transition configurations
#include "genesis/test/ByzToConFixAt5Test.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
    ...
    {
    //Client genesis
    case Network::sbercoinMainNetwork: return c_genesisInfoSbercoinMainNetwork;
    case Network::MainNetwork: return c_genesisInfoMainNetwork;
    case Network::Ropsten: return c_genesisInfoRopsten;

    //Test genesis
    case Network::sbercoinTestNetwork: return c_genesisInfoSbercoinTestNetwork;
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
    switch (_n)
    {
    case Network::sbercoinMainNetwork: return c_genesisStateRootSbercoinMainNetwork;
    case Network::sbercoinTestNetwork: return c_genesisStateRootSbercoinTestNetwork;
